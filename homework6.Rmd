...
# I don't know why the model is creating an x-axis that goes all the way to zero for some plots, and for others the axis starts at a higher value. 
```
...
Based on this project, the model does an excellent of simulating realistic data. Because the axes of my graphs are different (I'm not sure why), at first glance it would appear that thes simulated data set is more varied than the real data, but both data sets are actually within the range of 30-50 or so. 
